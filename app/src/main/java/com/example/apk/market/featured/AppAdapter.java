package com.example.apk.market.featured;
...
import com.example.apk.market.detail.DetailActivity;
...
public class AppAdapter extends RecyclerView.Adapter<AppAdapter.FeaturedViewHolder> {
    ...
    public void onBindViewHolder(FeaturedViewHolder holder, int position) {
        ...
        holder.tvCompany.setText(appInfo.getCategory());
        if (isShowOrder) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            RetrofitManager.getInstance(mContext).getDetailInfo(appInfo)
